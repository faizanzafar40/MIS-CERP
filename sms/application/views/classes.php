  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div id="add-class-messages"></div>
		  ...
		  <div class="form-group">
		    <label for="numericName" class="col-sm-4 control-label">Room Number : </label>
		    <div class="col-sm-8">
		      <input type="text" class="form-control" id="numericName" name="numericName" placeholder="Room Number">
		    </div>
		  </div>		  
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editClassModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
        <label for="editNumericName" class="col-sm-4 control-label">Room Number : </label>
        <div class="col-sm-8">
          <input type="text" class="form-control" id="editNumericName" name="editNumericName" placeholder="Room Number">
        </div>
      </div>      
      </div>
