	...
	public function fetchClassData($classId = null)
	{
		if($classId) {
			...
			foreach ($classData as $key => $value) {
				...
				$button = '
				    <a class="btn btn-default" type="button" data-toggle="modal" data-target="#editClassModal" onclick="editClass('.$value['class_id'].')"> <i class="glyphicon glyphicon-edit"></i> Edit</a>
				    <a class="btn btn-default" type="button" data-toggle="modal" data-target="#removeClassModal" onclick="removeClass('.$value['class_id'].')"> <i class="glyphicon glyphicon-trash"></i> Remove</a>
				</div>';
