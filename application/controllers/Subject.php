			    ...
			    <tbody>';
			    	if($subjectData) {
			    		foreach ($subjectData as $key => $value) {
			    			...
			    			$button = '
							    <a class="btn btn-default" type="button" data-toggle="modal" data-target="#editSubjectModal" onclick="editSubject('.$value['subject_id'].','.$value['class_id'].')"> <i class="glyphicon glyphicon-edit"></i> Edit</a>
							    
							    <a class="btn btn-default" type="button" data-toggle="modal" data-target="#removeSubjectModal" onclick="removeSubject('.$value['subject_id'].','.$value['class_id'].')"> <i class="glyphicon glyphicon-trash"></i> Remove</a>		    
