  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <label for="totalMark">Course Book</label>
		    <input type="text" class="form-control" id="totalMark" name="totalMark" placeholder="Course Book">
		  </div>
		  <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <label for="editTotalMark">Course Book</label>
		    <input type="text" class="form-control" id="editTotalMark" name="editTotalMark" placeholder="Course Book">
		  </div>
		  <div class="form-group">
